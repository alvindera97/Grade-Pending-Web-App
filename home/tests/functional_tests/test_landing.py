"""
   Test suite responsible for testing unit functionalities of the landing page
"""

from .main import Main, site_main_title


class TestLandingPage(Main):
    """Landing page unit tests."""

    def setUp(self) -> None:
        super().setUp()  # same as: super(TestLandingPage, self).setUp()
    ...
    def test_landing_page_title(self):
        ...
        # The title of the page (or landing page) reads:
        ...
        expected_text = "Calculate your GP in a matter of seconds with our" \
                        " grade pending calculator. It's fast, easy and reliable."
        self.assertEqual(welcome_text.text, expected_text)
    ...
    def test_login_button(self):
        """Test if the landing page button is functional"""
        ...
        login_button.click()
        landing_page_button = self.browser.find_element_by_id('login-button')
    ...
    def test_register_button(self):
        """Test if the landing page button is functional"""
        # James is now back at the landing page and proceeds to check the 'register button'
        landing_page_button = self.browser.find_element_by_id('register-button')
    ...
    def test_institutions_link(self):
        ...
        # James is back at the landing page
