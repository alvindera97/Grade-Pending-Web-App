...
class TestHomePage(Main):
    ...
    def test_login_button(self):
        ...
        # James is however confronted with 3 buttons that clearly spell out "Login", "Register" and "Institutions"
        ...
        # He can see from the login button that he is being directed to the login page because of the trailing
